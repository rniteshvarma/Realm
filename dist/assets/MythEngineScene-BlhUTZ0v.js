import{a3 as ue,f as ce,V as E,a4 as he,a5 as g,Y as X,Z as re,a6 as V,a7 as fe,a8 as me,B as ne,n as J,M as ve,k as de,r as n,a9 as pe,d as O,H as xe,b as j,X as Q,$ as ee,W as ge,aa as Me,ab as ye,ac as Se,a as I,u as we,S as Te,j as t,C as _e,D as be,c as De,E as Ue,g as P}from"./index-CIeHNeq0.js";import{a as Be}from"./SFXLibrary-DNUHASLa.js";import{r as $}from"./iridescent.vert-Cvl0ODfQ.js";import{P as Ce}from"./PerspectiveCamera-DE9pibGa.js";import{_ as Re}from"./Fbo-Bw4Tt_vM.js";import{T as G}from"./Text-DWZWlkur.js";const Fe=()=>parseInt(ue.replace(/\D+/g,"")),je=Fe();class Ee extends ce{constructor(e=new E){super({uniforms:{inputBuffer:new g(null),depthBuffer:new g(null),resolution:new g(new E),texelSize:new g(new E),halfTexelSize:new g(new E),kernel:new g(0),scale:new g(1),cameraNear:new g(0),cameraFar:new g(1),minDepthThreshold:new g(0),maxDepthThreshold:new g(1),depthScale:new g(0),depthToBlurRatioBias:new g(.25)},fragmentShader:`#include <common>
      ...
      `)}get tDiffuse(){return this._tDiffuse.value}set tDiffuse(e){this._tDiffuse.value=e}get tDepth(){return this._tDepth.value}set tDepth(e){this._tDepth.value=e}get distortionMap(){return this._distortionMap.value}set distortionMap(e){this._distortionMap.value=e}get tDiffuseBlur(){return this._tDiffuseBlur.value}set tDiffuseBlur(e){this._tDiffuseBlur.value=e}get textureMatrix(){return this._textureMatrix.value}set textureMatrix(e){this._textureMatrix.value=e}get hasBlur(){return this._hasBlur.value}set hasBlur(e){this._hasBlur.value=e}get mirror(){return this._mirror.value}set mirror(e){this._mirror.value=e}get mixBlur(){return this._mixBlur.value}set mixBlur(e){this._mixBlur.value=e}get mixStrength(){return this._blurStrength.value}set mixStrength(e){this._blurStrength.value=e}get minDepthThreshold(){return this._minDepthThreshold.value}set minDepthThreshold(e){this._minDepthThreshold.value=e}get maxDepthThreshold(){return this._maxDepthThreshold.value}set maxDepthThreshold(e){this._maxDepthThreshold.value=e}get depthScale(){return this._depthScale.value}set depthScale(e){this._depthScale.value=e}get depthToBlurRatioBias(){return this._depthToBlurRatioBias.value}set depthToBlurRatioBias(e){this._depthToBlurRatioBias.value=e}get distortion(){return this._distortion.value}set distortion(e){this._distortion.value=e}get mixContrast(){return this._mixContrast.value}set mixContrast(e){this._mixContrast.value=e}}const Ne=n.forwardRef(({mixBlur:u=0,mixStrength:e=.5,resolution:o=256,blur:i=[0,0],args:f=[1,1],minDepthThreshold:a=.9,maxDepthThreshold:s=1,depthScale:r=0,depthToBlurRatioBias:l=.25,mirror:c=0,children:v,debug:d=0,distortion:M=1,mixContrast:p=1,distortionMap:_,...U},B)=>{pe({MeshReflectorMaterial:Ae}),n.useEffect(()=>{console.warn("Reflector has been deprecated and will be removed next major. Replace it with <MeshReflectorMaterial />!")},[]);const m=O(({gl:h})=>h),b=O(({camera:h})=>h),z=O(({scene:h})=>h);i=Array.isArray(i)?i:[i,i];const H=i[0]+i[1]>0,S=n.useRef(null);n.useImperativeHandle(B,()=>S.current,[]);const[C]=n.useState(()=>new xe),[D]=n.useState(()=>new j),[R]=n.useState(()=>new j),[q]=n.useState(()=>new j),[A]=n.useState(()=>new Q),[L]=n.useState(()=>new j(0,0,-1)),[w]=n.useState(()=>new ee),[N]=n.useState(()=>new j),[W]=n.useState(()=>new j),[k]=n.useState(()=>new ee),[F]=n.useState(()=>new Q),[x]=n.useState(()=>new ge),oe=n.useCallback(()=>{if(R.setFromMatrixPosition(S.current.matrixWorld),q.setFromMatrixPosition(b.matrixWorld),A.extractRotation(S.current.matrixWorld),D.set(0,0,1),D.applyMatrix4(A),N.subVectors(R,q),N.dot(D)>0)return;N.reflect(D).negate(),N.add(R),A.extractRotation(b.matrixWorld),L.set(0,0,-1),L.applyMatrix4(A),L.add(q),W.subVectors(R,L),W.reflect(D).negate(),W.add(R),x.position.copy(N),x.up.set(0,1,0),x.up.applyMatrix4(A),x.up.reflect(D),x.lookAt(W),x.far=b.far,x.updateMatrixWorld(),x.projectionMatrix.copy(b.projectionMatrix),F.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),F.multiply(x.projectionMatrix),F.multiply(x.matrixWorldInverse),F.multiply(S.current.matrixWorld),C.setFromNormalAndCoplanarPoint(D,R),C.applyMatrix4(x.matrixWorldInverse),w.set(C.normal.x,C.normal.y,C.normal.z,C.constant);const h=x.projectionMatrix;k.x=(Math.sign(w.x)+h.elements[8])/h.elements[0],k.y=(Math.sign(w.y)+h.elements[9])/h.elements[5],k.z=-1,k.w=(1+h.elements[10])/h.elements[14],w.multiplyScalar(2/w.dot(k)),h.elements[2]=w.x,h.elements[6]=w.y,h.elements[10]=w.z+1,h.elements[14]=w.w},[]),[Y,ae,ie,K]=n.useMemo(()=>{const h={type:re,minFilter:V,magFilter:V},T=new X(o,o,h);T.depthBuffer=!0,T.depthTexture=new Me(o,o),T.depthTexture.format=ye,T.depthTexture.type=Se;const Z=new X(o,o,h),se=new Pe({gl:m,resolution:o,width:i[0],height:i[1],minDepthThreshold:a,maxDepthThreshold:s,depthScale:r,depthToBlurRatioBias:l}),le={mirror:c,textureMatrix:F,mixBlur:u,tDiffuse:T.texture,tDepth:T.depthTexture,tDiffuseBlur:Z.texture,hasBlur:H,mixStrength:e,minDepthThreshold:a,maxDepthThreshold:s,depthScale:r,depthToBlurRatioBias:l,transparent:!0,debug:d,distortion:M,distortionMap:_,mixContrast:p,"defines-USE_BLUR":H?"":void 0,"defines-USE_DEPTH":r>0?"":void 0,"defines-USE_DISTORTION":_?"":void 0};return[T,Z,se,le]},[m,i,F,o,c,H,u,e,a,s,r,l,d,M,_,p]);return I(()=>{if(!(S!=null&&S.current))return;S.current.visible=!1;const h=m.xr.enabled,T=m.shadowMap.autoUpdate;oe(),m.xr.enabled=!1,m.shadowMap.autoUpdate=!1,m.setRenderTarget(Y),m.state.buffers.depth.setMask(!0),m.autoClear||m.clear(),m.render(z,x),H&&ie.render(m,Y,ae),m.xr.enabled=h,m.shadowMap.autoUpdate=T,S.current.visible=!0,m.setRenderTarget(null)}),n.createElement("mesh",Re({ref:S},U),n.createElement("planeGeometry",{args:f}),v?v("meshReflectorMaterial",K):n.createElement("meshReflectorMaterial",K))}),te=`// runeEtching.glsl — Myth Engine monolith surfaces
